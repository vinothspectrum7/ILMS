...
import Rec_CustomNumericInput from '../receive/Rec_CustomNumericInput';
...
export default function Inv_LotSerialModalPopup({
  visible,
  onClose,
  lineQty = 0,
  itemName = '',
  ...
  useEffect(() => {
    ...
    const seedLots =
      Array.isArray(initialLots) && initialLots.length > 0
        ...
        ? initialData
        : [];
console.log(initialLots,"initialLotsinitialLots");
console.log(seedLots,"seedLotsseedLotsseedLotsseedLots")
