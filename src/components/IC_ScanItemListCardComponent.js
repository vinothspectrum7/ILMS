...
import IC_ScannedItemListCardComponent from './IC_ScannedItemListCardComponent';
import BarcodeScannerIcon from '../assets/icons/barcodescanner.svg';

const IC_ScanItemListCardComponent = ({
  dummyItems = [],
  scannedItems = [],
  onChange = () => {},
  onViewDetails = () => {},
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.cardWrap}>
              <IC_ScannedItemListCardComponent
                item={item}
                // index={index}
...
export default IC_ScanItemListCardComponent;
